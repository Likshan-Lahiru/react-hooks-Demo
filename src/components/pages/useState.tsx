                ...
                <div className="bg-white p-8 rounded-lg shadow-lg w-96">
                    ...
                    <div className="mb-3">
                        <input id="name"
                            ...
                            type="text" placeholder="Name" onChange={(e) => setName(e.target.value)}/></div>
                    <div className="mb-3">
                        <input
                            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div className="mb-3">
                        <input
                            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            type="number" placeholder="Contact" onChange={(e) => setContact(e.target.value)}/>
                    </div>
                    <button
                        className="w-full bg-blue-600 text-black font-bold py-2 rounded-lg hover:bg-blue-700 transition"
                        onClick={assignNewData}>Submit
                    </button>
                    <button   className="w-full bg-blue-600 text-black font-bold py-2 rounded-lg hover:bg-blue-700 transition" onClick={clear}>
